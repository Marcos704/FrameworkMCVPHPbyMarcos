        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 text-center">
              <h1 class="title">Cadastro de Ficha Pessoa Juridica</h1>
              <h5 class="sub-title">Finalizar Cadastro</h5>
              <div class="text-danger" id="retornoMsn1">Deseja finalizar o cadastro para a ficha ?</div>
            </div>
          </div>
          <hr>
          <br>
...
<script type="text/javascript" src="<?php echo URL_BASE ?>assets/js_master/proposta/pj/gerarPropostaPJ.js"></script>
