...
if (!$validacao->SECURITY_BLOCK_SYSTEM("mConfSistema", $_SESSION['cpf_usuario'])) {
  $d = $responser->msg('erro', 'Nível de Permissão requerida!<br>P: Master | M: Configurações | S: False');
}
$time = new Time();
$model = new SystemService();
$dados = $model->obterDadosAdministradora();

echo '<h1>Configurações de menu de personalização</h1><br><span>Em desenvolvimento</span>';
?>
<!--
              ...
              <div class="box-form-control">
                <div class="form-row">
                  <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control form-control-user" value="<?php //echo $dados[0]->cnpjAdministradora != null ? $time->getDataHoraAtualFomatted() : null ?>" disabled="disabled" placeholder="Data e Hora" required>
                  </div>
