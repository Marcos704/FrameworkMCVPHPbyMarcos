...
if (!$validacao->SECURITY_BLOCK_SYSTEM("mListPropostaPJ", $_SESSION['cpf_usuario'])) {
  $d = $responser->msg('erro', 'Nível de Permissão requerida!<br>P: Listar | M: PropostaPJ | S: False');
}
?>
		...
		<div class="card-body p-5">
			<div class="row">
				<div class="col-12 text-center">
					<h1 class="title">Cadastro de Banco<br>ou<br>Administradora responsavel</h1>
							...
							<div class="col-lg-4 col-md-4 col-sm-12">
								<div class="form-row">
									<div class="form-group col-12">
										<input type="text" class="form-control form-control-user text-center" id="nome_banco" name="nome_banco_administradora" placeholder="Nome do banco" required>
									</div>
									<div class="form-group col-12">
										<input type="text" class="form-control form-control-user text-center" id="cnpj_banco" name="cnpj_banco_administradora" placeholder="CNPJ" required>
									</div>
								</div>
							</div>
...
<script type="text/javascript" src="<?php echo URL_BASE ?>assets/js_master/banco/cadastroBanco.js"></script>