...
$("#editar_ficha_pessoa_fisica").submit(function () {
  event.preventDefault();
  var formData = new FormData(this);
  $.ajax({
    url: URL_BASE + "System/editarPropostaCPF",
    type: 'POST',
    data: formData,
    ...
    success: function (retorno) {
      ...
      if (retorno.trim().includes("ficha editada")) {
        $('#retornoMsn1')
          .addClass('alert alert-success')
          .html('<strong>Ficha editada!</strong></p>');
          setTimeout(function() {
